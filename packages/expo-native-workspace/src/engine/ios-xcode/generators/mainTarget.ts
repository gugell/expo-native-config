...
const SCRIPT_MARKER = '# @generated expo-native-workspace';
...
export const mainTargetGenerator: Generator = {
  ...
  generate({ manifest }) {
    ...
    if (resources.length > 0) {
      ...
      if (duplicate) {
        throw new Error(
          `[expo-native-workspace] ios.resources has two entries named ${duplicate}; resources are copied next to the generated project by basename.`,
        );
      }
