...
const POST_INSTALL_TAG = 'expo-native-workspace-podfile-post-install';
const LINES_TAG = 'expo-native-workspace-podfile-lines';
const AUTOLINKING_TAG = '# expo-native-workspace-autolinking-exclude';
