...
const TAGS = {
  repositories: 'expo-native-workspace-android-repositories',
  buildscript: 'expo-native-workspace-android-buildscript',
  plugins: 'expo-native-workspace-android-plugins',
  defaultConfig: 'expo-native-workspace-android-default-config',
  resolution: 'expo-native-workspace-android-resolution',
  modules: 'expo-native-workspace-android-modules',
} as const;
...
export const gradleExtrasGenerator: Generator = {
  ...
  generate({ manifest }) {
    ...
    if (exclude.length > 0) {
      const marker = '// expo-native-workspace-autolinking-exclude';
      tag(
        {
