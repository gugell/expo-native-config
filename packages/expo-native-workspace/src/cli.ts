...
program
  ...
  .action((shell = 'bash') => {
    if (shell === 'bash') console.log(`complete -W "${commands}" expo-native-workspace`);
    else if (shell === 'zsh')
      console.log(`#compdef expo-native-workspace\n_arguments '1:command:(${commands})'`);
    else if (shell === 'fish') console.log(`complete -c expo-native-workspace -f -a '${commands}'`);
